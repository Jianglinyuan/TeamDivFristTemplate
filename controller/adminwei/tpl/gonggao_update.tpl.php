...
<!--   <table width="100%" cellspacing="0">
        ...
        <div class="row">
          <div class="input-field col s6">
            <input id="input_text" type="text" length="15" name="title" value="<?php echo $slideone['title'];?>">
            <label for="input_text">公告标题</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s6">
            <textarea id="textarea1" class="materialize-textarea" length="120" name="content" ><?php echo $slideone['content'];?></textarea>
