...
class home extends base {
	...
	public function userrecharge(){
		$member=$this->userinfo;
	$title="账户充值";
		$paylist = $this->db->GetList("SELECT * FROM `@#_pay` where `pay_start` = '1'and `pay_class`!='wapalipay'and `pay_class`!='chinabankwap'and `pay_class`!='wxpay_web'and `pay_class`!='unionpay_web'and `pay_class`!='jdpay'");		
