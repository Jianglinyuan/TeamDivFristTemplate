            ...
            GetJPData(Gobal.Webpath, "ajax", "getLotteryList" + o(),
                function(s) {
                    if (s.code == 0) {
                        ...
                        var t = r.length;
                        for (var q = 0; q < t; q++) {
                        var v = '<ul id="' + r[q].id + '"><li class="revConL">' + (r[q].codeType == 1 ? '<span class="z-limit-tips">限时揭晓</span>' : "") + '<img  src="' + Gobal.imgpath + '/uploads/' + r[q].thumb + '"></li><li class="revConR"><dl><dd><img name="uImg" uweb="' + r[q].q_uid + '" src="' + Gobal.imgpath + '/uploads/' + r[q].userphoto + '"></dd><dd><span><a name="uName" uweb="' + r[q].q_uid + '" class="rUserName blue">' + r[q].q_user + '</a> <strong>:</strong>ئېرىشكۈچى</span><em class="orange arial">' + r[q].gonumber + '</em><strong>:جەمئىي سېتىۋېلىش</strong></dd></dl><dt><em class="orange arial">' + r[q].q_user_code + '</em> : تەلەيلىك نۇمۇر<br/><em class="c9 arial">' + r[q].q_end_time + '</em>:جاكارلانغان ۋاقىت</dt><b class="fr z-arrow"></b></li></ul>';
                            var u = $(v);
                            u.click(function() {
