$(function() {
	...
	var h = function() {
		...
		var o = function(r, q) {
			GetJPData("http://m.yygcms.com", "addShopCart", "codeid=" + r + "&shopNum=" + q, function(s) {
				if (s.code == 0) {
		...
		var n = function() {
			...
			var r = function() {
				b.show();
				GetJPData("http://m.yygcms.com", "getGoodsPageList", q(), function(u) {
					if (u.code == 0) {
						var t = u.listItems;
						if (e.isCount == 1) {
							f = u.count;
						...
						var B = 0;
						for (var v = 0; v < x; v++) {
							var w = '<ul id="' + t[v].goodsID + '"><li><span class="z-Limg"><img src="' + Gobal.LoadPic + '" src2="http://mimg.yygcms.com/GoodsPic/pic-200-200/' + t[v].goodsPic + '">';
							if (t[v].codeType == 1) {
